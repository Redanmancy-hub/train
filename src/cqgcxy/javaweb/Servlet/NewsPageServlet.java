...
@WebServlet(urlPatterns = "/NewsListPage.do")
public class NewsPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<News> newsListPage = newsDao.newsPage(currPage,pageSize);//当前分页的数据集
        request.getSession().setAttribute("listNews",newsListPage);
        // 查询后跳转到视图
